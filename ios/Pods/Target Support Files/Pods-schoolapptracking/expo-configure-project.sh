...
with_node \
  ...
  --target "/Users/pranay/Desktop/personal/pradeep/school-app-tracking/ios/Pods/Target Support Files/Pods-schoolapptracking/ExpoModulesProvider.swift" \
  --entitlement "/Users/pranay/Desktop/personal/pradeep/school-app-tracking/ios/schoolapptracking/schoolapptracking.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-blur" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-haptics" "expo-keep-awake" "expo-linking" "expo-location" "expo-maps" "expo-router" "expo-sensors" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
